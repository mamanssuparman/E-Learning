<form name="save" method="POST" action="<?php echo base_url();?>index.php/guru/Quiz/Simpan">
	<div class="row">
		<div class="col-md-12">
			<p>
				Nama Tes/ Quiz
				...
				<select multiple="multiple" data-placeholder="Pilih Kelas" style="width: 100%;" required name="id_kelas[]">
		      		<?php 
		      			foreach ($data_kelas->result_array() as $showkelas):
		      				echo "<option value='$showkelas[id_kelas]'>$showkelas[nama_kelas] [$showkelas[jml_siswa]]</option>";
		      			endforeach;
		      		?>
		      	</select>
			</p>
